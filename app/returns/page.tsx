    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="prose prose-gray max-w-none">
        ...
        <p className="text-muted-foreground mb-8 text-lg">
          ...
          your order, we are here to help with our hassle-free return policy.
        </p>
          ...
          <div className="space-y-4 text-gray-700">
            ...
            <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
              ...
              <p className="text-blue-700">
                ...
                the original item. This way, you will not have to wait for the return to be
                processed.
              </p>
            </div>
          </div>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4 text-gray-700">
            ...
            <ul className="list-disc space-y-2 pl-6">
              <li>
                Return shipping costs are the customers responsibility for international orders
              </li>
