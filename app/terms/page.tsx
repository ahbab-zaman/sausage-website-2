    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="prose prose-gray max-w-none">
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4 text-gray-700">
            <p>
              Permission is granted to temporarily download one copy of the materials on Stores
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4 text-gray-700">
            <p>
              ...
              arising out of the use or inability to use the materials on Stores website, even
