...
//   return (
//     <div className="overflow-hidden rounded-lg bg-white shadow-sm transition-shadow duration-300 hover:shadow-md max-w-[300px] mx-h-[360px] px-2">
//       {/* Top Part */}
...
//               alt={product.name}
//               className="object-contain p-4 max-w-[220px] max-h-[300px] mx-auto"
//             />
//           </div>
//         </Link>
//       </div>
...
//               className="flex flex-1 items-center justify-center gap-2 rounded-full bg-[#AA383A] px-4 py-2.5 text-white transition-colors">
//               <svg
